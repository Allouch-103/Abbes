...
\begin{itemize}[itemsep=2pt,topsep=4pt]
  ...
  \item \textbf{Inverted-pendulum approach}~\cite{shahbazi2016} --- operates
        with limited knowledge of the robot model and uses a closed-loop
        feedback based on the inverted-pendulum abstraction.
\end{itemize}
...
A walking primitive~\cite{hauser2008} is a fundamental building block that
generates the motion of a robot's gait. It defines characteristics such as step
