...
joint angles, drive the servos smoothly through the two PCA9685 boards,
read the MPU6050 inertial sensor, and make all of this available to the
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[
    ...
    \node[hw, right=14mm of servo] (pca) {2$\times$PCA9685\\$\rightarrow$ 18 servos};
...
device has its own address. This is what allows three peripherals --- the
two PCA9685 boards (at addresses 0x40 and 0x41) and the MPU6050 --- to be
controlled through only two microcontroller pins.
...
appropriate PCA9685 channel. Two safeguards are applied in the process.
